...
const services = [
  {
    ...
    details: [
      `We offer a comprehensive range of Audit and Assurance services
      conducted in accordance with applicable laws, rules, and the
      Standards on Auditing issued by the Institute of Chartered
      Accountants of India (ICAI). Our objective is to provide
      stakeholders with an independent and objective opinion on the
      financial statements and internal controls, ensuring transparency,
      accountability, and regulatory compliance.
      Independent, Ethical, and Compliant Assurance Solutions
      Statutory`,
    ],
    image:
